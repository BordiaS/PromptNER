...
class TweetNerdConfig(Config):
    
    person ="Politicians, sports players, artists, celebrities, fictional characters, scientists, singers, musicians, journalists, social media celebrities, and others Examples: Kanye West, Sachin Tendulkar, Donald Trump, Harry Potter, Jon  Snow"
    place = "Countries, Cities, Monuments, Parks, rivers, and others Examples: Paris, Nigeria, Statue of Liberty"
    organization =  "Companies, governments, NGOs, social movements, music bands, sports teams, social organizations, volunteer organizations, and others Examples: Backstreet Boys, Los Angeles Lakers, Black Lives Matter"
    products = "Websites, Softwares, applications, video games, technology gadgets, devices, and others Examples: PlayStation, iPhone, GoFundMe, Roblox"
    works_of_art = "Movies, Albums, Books, Comics, Video Games, TV Shows, Social Media videos, and others Examples: Friends, The Office, Lupin"
    scientific_concepts = "Names of diseases, drugs, names of algorithms, scientific methods and techniques, scientific names of organisms, names of disasters, and others Examples: COVID-19, SARS-COV19, Hurricane Katrina, Cyclone Idai"
    train_group = f"{person}, {place}, {organization},{products},{works_of_art},{scientific_concepts}"



class TweetNerdOOOConfig(TweetNerdConfig):
    defn = f"""
        Entities are  {TweetNerdConfig.train_group}
        """
...
class TweetNerdAcademicConfig(TweetNerdConfig):
    defn = f"""
        Entities are  {TweetNerdConfig.train_group}
        """
...
class TweetNerdTestConfig(TweetNerdConfig):
    defn = f"""
        Entities are  {TweetNerdConfig.train_group}
        """
